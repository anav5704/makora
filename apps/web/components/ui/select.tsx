    ...
    return (
        <Field>
            ...
            <Listbox value={selectedItem} onChange={setSelectedItem}>
                <ListboxButton className="flex items-center justify-between cursor-pointer text-left mt-2.5 px-4 py-2.5 w-full rounded-md border border-zinc-700 bg-zinc-800">
                    {selectedItem.name}
                    <ChevronDown size={24} />
                </ListboxButton>
                <ListboxOptions
